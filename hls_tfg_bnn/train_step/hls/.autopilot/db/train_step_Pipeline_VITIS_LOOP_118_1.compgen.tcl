...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_pos \
    op interface \
    ports { in_pos_address0 { O 6 vector } in_pos_ce0 { O 1 bit } in_pos_we0 { O 1 bit } in_pos_d0 { O 2 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_pos'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_neg \
    op interface \
    ports { in_neg_address0 { O 6 vector } in_neg_ce0 { O 1 bit } in_neg_we0 { O 1 bit } in_neg_d0 { O 2 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_neg'"
}
}
