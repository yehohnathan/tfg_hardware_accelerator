...
HLS_SOURCES = ../../../../../tb/train_tb.cpp ../../../../../src/forward_fw.cpp
...
$(ObjDir)/train_tb.o: ../../../../../tb/train_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb/train_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/train_tb.d

$(ObjDir)/forward_fw.o: ../../../../../src/forward_fw.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../src/forward_fw.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/forward_fw.d
