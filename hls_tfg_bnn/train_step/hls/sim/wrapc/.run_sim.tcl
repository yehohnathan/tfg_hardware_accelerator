...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "train_step.autotvin.dat"
	set constFileTvOut       "train_step.autotvout.dat"
	set constFileHdlTvIn     "train_step.autohdltvin.dat"
	set constFileHdlTvOut    "train_step.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
