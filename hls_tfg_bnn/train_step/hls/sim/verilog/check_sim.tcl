...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.train_step.autotvin_WEIGHTS.dat"
         "c.train_step.autotvin_img_pos.dat"
         "c.train_step.autotvin_img_neg.dat"
         "c.train_step.autotvin_W1.dat"
         "c.train_step.autotvin_W2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.train_step.autotvout_WEIGHTS.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
