...
if {[file isfile train_step.autotvin.dat]} {
	file delete -force train_step.autotvin.dat
}

if {[file isfile train_step.autotvout.dat]} {
	file delete -force train_step.autotvout.dat
}
