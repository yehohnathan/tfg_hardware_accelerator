...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a32a64struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.98"([32 x [64 x i8]]* align 512 %5, [32 x [64 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* %4)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a10a32struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.84"([10 x [32 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* %6, [10 x [32 x i8]]* align 512 %7)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a10a32struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.84"([10 x [32 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* noalias %dst, [10 x [32 x i8]]* noalias readonly align 512 %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a10a32struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.87"([10 x [32 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* nonnull %dst, [10 x [32 x i8]]* nonnull %src, i64 10)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a10a32struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.87"([10 x [32 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* %dst, [10 x [32 x i8]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a32struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.90"([32 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]* %dst.addr, [32 x i8]* %3, i64 32)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a32struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.90"([32 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]* %dst, [32 x i8]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a32a64struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.98"([32 x [64 x i8]]* noalias align 512 %dst, [32 x [64 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* noalias readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a32a64struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.101"([32 x [64 x i8]]* nonnull %dst, [32 x [64 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* nonnull %src, i64 32)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a32a64struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.101"([32 x [64 x i8]]* %dst, [32 x [64 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a64struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.104"([64 x i8]* %3, [64 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]* %src.addr, i64 64)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a64struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>.104"([64 x i8]* %dst, [64 x %"struct.ap_fixed<8, 8, AP_TRN, AP_WRAP, 0>"]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
